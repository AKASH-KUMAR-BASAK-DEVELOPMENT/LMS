                ...
                <div class="col-12 col-lg-6 m-auto">
                    <div class="row my-5">
                        <div class="col-sm-10 col-xl-8 m-auto">
                            <!-- Title -->
                            <span class="mb-0 fs-1"><lottie-player src="{{ asset('frontend-1/assets/lottifiles/Animation - 1716786872050.json') }}" speed="1" style="width: 50px; height: 50px;" loop autoplay direction="1" mode="normal"></lottie-player></span>
                            <h1 class="fs-2">Login into Educube!</h1>
                            ...
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="password" class="form-control border-0 bg-light rounded-end ps-1" name="password" placeholder="password" id="inputPassword5">
                                    </div>
...
{{--                                </div>--}}
                            ...
                            <div class="mt-1 text-center">
                                <span>Don't have an account? <a href="/sign-up-form">Signup here</a></span>
                            </div>
                        </div>
                    </div> <!-- Row END -->
                </div>
