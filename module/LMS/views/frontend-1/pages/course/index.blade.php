...
{{--                                <th scope="col" class="border-0">Price</th>--}}
                            ...
                            <tr>
                                ...
                                <td> <span class=""><a href="{{ route('course-assessment.create', ['course_id' => $course->id]) }}" class="btn btn-sm btn-info-soft me-1 mb-1 mb-md-0"><i class="bi bi-dropbox fa-fw"></i> Assessment File</a></span> </td>
{{--                                <td>${{ $course->price ?? 0 }}</td>--}}
                                <td> <span class="badge bg-warning bg-opacity-15 text-success">{{ $course->status==1 ? 'Active' : 'Inactive' }}</span> </td>
                                <td>
                                    <a href="{{ route('course.show', $course->id) }}" class="btn btn-sm btn-primary-soft me-1 mb-1 mb-md-0">Show</a>
                                    <a href="{{ route('course.edit', $course->id) }}" class="btn btn-sm btn-success-soft me-1 mb-1 mb-md-0">Edit</a>
