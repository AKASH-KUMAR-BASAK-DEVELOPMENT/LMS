        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <section>
                        <div class="container">
                            <form action="{{ route('topic.store') }}" id="topic_form" method="post" onsubmit="return false" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="modal-body">
                                                <div class="row text-start g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" type="text" id="topicVideoLink" name="topic_video_link" value="" placeholder="Enter Video link">
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <input class="form-control" type="file" name="topic_image" id="topicImage" placeholder="Enter Video link">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <input class="form-control" type="file" name="topic_video" id="topicVideo" placeholder="Enter Video link">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-12 mt-3">
                                                        ...
                                                        <textarea class="form-control" id="topicDescription" name="topic_description" rows="4" placeholder="" spellcheck="false"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
