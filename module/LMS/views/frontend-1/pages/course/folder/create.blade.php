        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <section>
                        <div class="container">
                            <form action="{{ route('folder.store') }}" id="folder" method="post" onsubmit="return false" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="modal-body">
                                                <div class="row text-start g-3">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input class="form-control" type="text" name="name" value="" placeholder="Enter folder name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
