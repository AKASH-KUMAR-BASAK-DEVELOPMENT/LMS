@if(\Module\LMS\Models\CourseAssessmentModel::where('curriculum_id', $curriculum->id)->where('folder_id',  $folder->id)->count() > 0)
    <div class="col-12 mb-1">
        <div>
            <!-- Comment -->
            <div class="p-2">
                @foreach(\Module\LMS\Models\CourseAssessmentModel::where('curriculum_id', $curriculum->id)->where('folder_id', $folder->id)->get() as $exam)
