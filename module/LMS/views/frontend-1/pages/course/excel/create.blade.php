...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <section>
                        <div class="container">
                            <form action="{{ route('excel.store') }}" method="post" id="excel_form" onsubmit="return false" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="row text-start g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label">Upload Document <i class="fa fa-file-pdf"></i> <span style="font-size: 10px; color: indianred; font-style: italic;">(.xlx format only)</span></label>
                                                        <br>
                                                        <div class="row">
                                                            <div class="col-md-12">
    ...
    <script>
        function submitForm() {
            ...
            var form = document.getElementById('excel_form');
    ...
    <script>
        function validateFileExtension(event) {
            ...
            const fileInput = document.getElementById('topicDocument'); // Update this to match the input field for the Excel file
