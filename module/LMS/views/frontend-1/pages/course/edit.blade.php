            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <p class="text-white mb-0">Read our <a href="#" class="text-white"><u>"Before you edit  a
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto text-center">
                        <p class="text-center">Use this interface to edit a existing Course to the portal. Once you are done
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="d-md-flex justify-content-between align-items-start mt-4">
                                                ...
                                                <div class="text-md-end">
                                                    ...
                                                    <p class="mb-0 small mt-1">Once you click "Update Course", your
