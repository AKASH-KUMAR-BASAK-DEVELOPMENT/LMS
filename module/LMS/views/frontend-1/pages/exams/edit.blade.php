...
@section('content')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <!-- Title -->
                        <h1 class="text-white">Submit a new Exam</h1>
                        <p class="text-white mb-0">This exam is associated with a specific course</p>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="bs-stepper-header" role="tablist">
                                ...
                                <div class="step" data-target="#step-1">
                                    <div class="d-grid text-center align-items-center">
                                        ...
                                        <h6 class="bs-stepper-label d-none d-md-block">Exam details</h6>
                                    </div>
                                </div>
                                <div class="line"></div>
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <select class="form-select js-choice border-0 z-index-9 bg-transparent"
                                                        name="course_id" aria-label=".form-select-sm"
                                            ...
                                            <div class="card shadow rounded-2 p-0">
                                                <div class="card-header border-bottom px-4 py-3">
                                                    <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
                                                        ...
                                                        <li class="nav-item me-2 me-sm-4" role="presentation">
                                                            <button class="btn btn-info-soft mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false" tabindex="-1" onclick="addQuestion('Selection')">Selection</button>
                                                        </li>
                                                        ...
                                                        <li class="nav-item me-2 me-sm-4" role="presentation">
                                                            <button class="btn btn-info-soft mb-2 mb-md-0" id="course-pills-tab-4" data-bs-toggle="pill" data-bs-target="#course-pills-4" type="button" role="tab" aria-controls="course-pills-4" aria-selected="false" tabindex="-1" onclick="addQuestion('Essay')">Essay</button>
                                                        </li>

                                                        <li class="nav-item me-2 me-sm-4" role="presentation">
                                                            <button class="btn btn-info-soft mb-2 mb-md-0" id="course-pills-tab-5" data-bs-toggle="pill" data-bs-target="#course-pills-5" type="button" role="tab" aria-controls="course-pills-5" aria-selected="false" tabindex="-1" onclick="addQuestion('Short Answer')">Short Answer</button>
                                                        </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <button type="submit" class="btn btn-success mb-2 mb-sm-0"
                                                        onclick="submitForm()">Submit a Exam
                                                </button>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        function questionTypeHtmlEmbedded(activeQuestionType, lessonCounter){
            const trueFalseEmbedded = `<div class="card shadow rounded-2 p-0">
                <div class="card-header border-bottom px-4 py-3">
                    <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
                        ...
                        <li class="nav-item me-2 me-sm-4" role="presentation">
                            <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">True/False</button>
                        </li>
                    </ul>
                            <br>
            ...
            const selectionEmbedded = `<div class="card shadow rounded-2 p-0">
                <div class="card-header border-bottom px-4 py-3">
                    <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
                        ...
                        <li class="nav-item me-2 me-sm-4" role="presentation">
                            <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Selection</button>
                        </li>
                    </ul>
                ...
                <div class="card-body p-4">
                    ...
                    <div id="appendSelectionOption${lessonCounter}">
                                <input type="text" class="col-lg-6" name="option1${lessonCounter}" placeholder="Enter option 1" required><br><br>
                                <input type="text" class="col-lg-6" name="option2${lessonCounter}" placeholder="Enter option 2" required><br><br>
                                <input type="text" class="col-lg-6" name="option3${lessonCounter}" placeholder="Enter option 3" required><br><br>
                                <input type="text" class="col-lg-6" name="option4${lessonCounter}" placeholder="Enter option 4" required><br><br>
            ...
            const fillInTheBlanksEmbedded = `<div class="card shadow rounded-2 p-0">
                <div class="card-header border-bottom px-4 py-3">
                    <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
                        ...
                        <li class="nav-item me-2 me-sm-4" role="presentation">
                            <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Fill in the blanks</button>
                        </li>
                    </ul>
            ...
            const essayEmbedded = `<div class="card shadow rounded-2 p-0">
                <div class="card-header border-bottom px-4 py-3">
                    <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">

                        <li class="nav-item me-2 me-sm-4" role="presentation">
                            <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Essay</button>
                        </li>
                    </ul>
            ...
            const shortAnswerEmbedded = `<div class="card shadow rounded-2 p-0">
                <div class="card-header border-bottom px-4 py-3">
                    <ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">

                        <li class="nav-item me-2 me-sm-4" role="presentation">
                            <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Short Answer</button>
                        </li>
                    </ul>
            ...
            if(activeQuestionType === 'Essay'){
                return essayEmbedded;
            }
            if(activeQuestionType === 'Short Answer'){
                return shortAnswerEmbedded;
            }
    ...
    <script>
        function addMoreOptionSelection(event, lessonCounter) {
            ...
            const newOptionHtml = `<input type="text" class="col-lg-6" name="option${newOptionNumber}${lessonCounter}" placeholder="Enter option ${newOptionNumber}" required><br><br>`;
