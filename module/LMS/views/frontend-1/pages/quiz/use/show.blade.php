...
{{--                @include('frontend-1.partials.dashboard-sidebar')--}}
                <div class="col-xl-12">
                    <!-- =======================
    Page intro START -->
                    <section class="bg-light rounded py-0">
                        <div class="container">
                            <div class="row py-5">
                                <div class="col-lg-8 px-4">
                                    <!-- Badge -->
                                    <h6 class="mb-3 font-base bg-primary text-white py-2 px-4 rounded-2 d-inline-block">{{ $exam->curriculum->course->title }}</h6>
                                    <!-- Title -->
                                    <h1>{{ $exam->curriculum->name }}: <span class="text-success">{{ $exam->name }}</span> quiz</h1>
                                    <!-- Content -->
