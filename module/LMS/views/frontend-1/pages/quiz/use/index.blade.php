                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive border-0 rounded-3">
                                            <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                                                <thead>
                                                <tr>
                                                    <th scope="col" class="border-0 rounded-start">Quiz Name</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(isset($exam->date) && Carbon\Carbon::parse($exam->date)->format('d m y') == now()->format('d m y'))
                                                                <a href="{{ route('student-quiz-enrollments.edit', $exam->id) }}" class="btn btn-sm btn-success-soft me-1 mb-1 mb-md-0">Start Exam</a>
