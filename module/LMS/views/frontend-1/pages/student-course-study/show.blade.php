...
{{--                                    <li class="list-inline-item text-white">(1,586 reviews)</li>--}}
                    ...
                    <div class="col-lg-3">
                        ...
                        <!-- Button -->
                        @if(isset($course->courseAssessments[0]->id))
                        <a href="{{ route('course-assessment.edit', $course->courseAssessments[0]->id) }}" class="btn btn-warning mb-3 w-100">Course Assessment</a>
                    @else
                            <a class="btn btn-warning mb-3 w-100">Wait For Assessment File!</a>
                    @endif
                        <!-- Progress item -->
                        ...
                        <div class="card shadow rounded-2 p-0 mt-n5">
                            ...
                            <div class="card-header border-bottom px-4 pt-3 pb-0">
                                <ul class="nav nav-bottom-line py-0" id="course-pills-tab" role="tablist">
                                    ...
                                    <!-- Tab item -->
                                    <li class="nav-item me-2 me-sm-4" role="presentation">
                                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false" tabindex="-1">Learning Resource</button>
                                    </li>
                                </ul>
                            </div>
                            <!-- Tabs END -->
                                            ...
                                            @foreach(\Module\LMS\Models\CourseCurriculumModel::where('course_id', $course->id)->get() as $index => $curriculum)
                                                <div class="accordion-item mb-3">
                                                    <h6 class="accordion-header font-base" id="heading-{{ $index }}">
                                                        <button class="accordion-button fw-bold rounded d-flex collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-{{ $index }}" aria-expanded="false" aria-controls="collapse-{{ $index }}">
                                                            {{ $curriculum->name }}
                                                            <span class="small ms-0 ms-sm-2 d-none d-sm-block">({{ sizeof($curriculum->curriculumTopics) }} Topics)</span>
...
{{--                                                                            @if(checkUrl($learningResource->link) == true)--}}
{{--                                                                            <div class="text-center">--}}
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header border-bottom p-0 pb-3">
                                                ...
                                                <div class="d-sm-flex justify-content-between align-items-center">
                                                    <h4 class="mb-0">Learning Resource</h4>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="bg-light border rounded p-4">
                                                            <div class="mt-3">
                                                                ...
                                                                @foreach($course->courseScormPackages as $course->courseScormPackage)
                                                                    <li><span><span>{{ $course->courseScormPackage->link }}</span> &nbsp;&nbsp;&nbsp; <a href="/scorm/{{ $course->courseScormPackage->link }}" target="_blank" class="btn btn-primary"><i class="fas fa-fw fa-box-open"></i> OPEN</a></span></li>
                                                                @endforeach
                                                                </ol>
                                                            </div>
                                                        </div>
