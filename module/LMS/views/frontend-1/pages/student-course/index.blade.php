                                                ...
                                                @forelse($courses as $course)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @php
                                                                $resultCard = \Module\LMS\Models\StudentCourseResultModel::where('student_id', auth()->user()->id)->where('course_id', $course->id)->value('id');
                                                            @endphp
                                                            @if(isset($resultCard))
                                                                <a href="{{ route('student-course-result.show', $resultCard) }}" class="btn btn-sm btn-primary-soft me-1 mb-1 mb-md-0">Result</a>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @empty
