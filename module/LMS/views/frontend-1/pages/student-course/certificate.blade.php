...
<div class="certificate-container">
    <div class="certificate">
        <div class="header">
            <img src="{{ asset(company()->logo) }}" alt="W3Schools Logo" class="logo">
            <h1>CERTIFICATE OF COMPLETION</h1>
        </div>
        <p>This certifies that</p>
        <h2>{{ $student->name }}</h2>
        <p>has completed the necessary courses of study and passed<br>
            the W3Schools' {{ $studentCourseCertificate->title }} exams and he/she is achieve</p>
        <h3>Certified {{ $studentCourseCertificate->title }}</h3>
        <p>our <span class="grade-style">{{ $courseResult->grade }}</span> grade</p>
        <div class="footer">
            <p>Issued May 18, 2022</p>
            <div class="signature">
                <img src="{{ asset('frontend-1\assets\images\certificate-signature.png') }}" alt="Signature">
                <p>Thomas Thorsell-Arntsen<br>for {{ company()->name }}</p>
            </div>
        </div>
