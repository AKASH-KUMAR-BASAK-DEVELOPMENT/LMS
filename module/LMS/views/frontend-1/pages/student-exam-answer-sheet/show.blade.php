                ...
                <div class="card border">
                    <div class="card-header border-bottom">
                        ...
                        <div class="card">
                            <div class="row g-0">
                                <div class="col-md-2">
                                    <img src="{{ asset($examEnrollment->exam->course->image) }}" class="rounded-2"
                                         alt="Card image" style="height: 170px !important; width: auto !important;">
                                </div>
                                <div class="col-md-10">
                                    <div class="card-body">
                                        <!-- Title -->
                                        <h3 class="card-title"><a href="#">{{ $examEnrollment->exam->name }}</a></h3>
                                        ...
                                        <ul class="list-inline mb-2">
                                            ...
                                            <li class="list-inline-item h6 fw-light"><i
                                                    class="fas fa-signal text-info me-2"></i>{{ $examEnrollment->exam->course->courseLevel->name }}
                                            </li>
                                        </ul>
                    ...
                    <div class="card-body">
                        ...
                        <form action="/exam-answer-marking" method="post">
                            @csrf
                            @method('POST')
                            <!-- Accordion START -->
                                                        ...
                                                        <span
                                                            class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-sm-400px mt-2">
                                                                    <div class="input-group-2">
                                                                        ...
                                                                        <input type="number" class="input-2" id="mark" name="mark[]" value="{{ $examAnswerSheet->mark }}" autocomplete="off">
</div>
                                                                </span>
                                                    </div>
                                                </div>
