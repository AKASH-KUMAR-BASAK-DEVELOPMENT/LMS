<!-- =======================
    Main Banner START -->
<section class="pt-0 position-relative overflow-hidden h-700px h-sm-600px h-lg-700px rounded-top-4 mx-2 mx-md-4" style="background-image:url({{ asset($banner->image) }}); background-position: center; background-size: cover;">
            ...
            <div class="col-sm-10 col-lg-8 col-xl-6 all-text-white my-5 mt-md-0">
                <div class="py-0 py-md-5 my-5">
                    ...
                    <div class="d-inline-block bg-white px-3 py-2 rounded-pill mb-3">
                        <p class="mb-0 text-dark"><span class="badge text-bg-success rounded-pill me-1">New</span>	Real time live video online exam system </p>
                    </div>

                    <!-- Title -->
                    <h1 class="text-white display-5">Start learning from <span class="text-warning">best E-Learn system</span></h1>
                    <p class="text-white">We committed to give you user friendly learning experience. Our E-learn system help you to learn multiple qualification and test your skill what you achieve.</p>

                    <div class="d-sm-flex align-items-center mt-4">
                        <!-- Button -->
                        <a href="#" class="btn btn-primary me-2 mb-4 mb-sm-0">E-Learn Tour</a>
                        <!-- Video button -->
