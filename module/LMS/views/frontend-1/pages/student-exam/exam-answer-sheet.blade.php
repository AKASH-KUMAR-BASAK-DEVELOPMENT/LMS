                        ...
                        <div class="card border shadow">
                            ...
                            <div class="card-header border-bottom">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="row g-0">
                                                <div class="col-md-2">
                                                    <img src="{{ asset($exam->course->image ?? 'frontend-1/assets/images/exam-default-image.png') }}" class="rounded-2"
                                                         alt="Card image">
                                                </div>
                                                <div class="col-md-10">
                                                    <div class="card-body">
                                                        <!-- Title -->
                                                        <h3 class="card-title"><a href="#">{{ $exam->name }} exam</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <h6 class="text-danger text-end mb-0"><i class="bi bi-clock-history me-2"></i><span
                                        id="timer">Exam Time: {{ $exam->duration }}</span></h6>
                                <!-- Course list END -->
                            </div>
