...
class StudentQuizController extends Controller
{
    ...
    */
    ...
    {
        $data['exams'] = ExamModel::active()->where('type', 'quiz')->whereHas('curriculum.course.courseEnrollments', function ($query) {
            ...
            ->get();
        return view('frontend-1.pages.quiz.use.index', $data);
    }
