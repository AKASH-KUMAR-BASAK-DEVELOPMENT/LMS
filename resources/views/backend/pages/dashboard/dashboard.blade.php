...
@section('content')
    <div class="row">
            ...
            <div class="card bg-c-yellow update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            <h4 class="text-white">{{ courseCount() }}</h4>
                            <h6 class="text-white m-b-0">Total Courses</h6>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-c-green update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            <h4 class="text-white">${{ number_format(coursePriceSum(), 2) }}</h4>
                            <h6 class="text-white m-b-0">Course Revenue</h6>
                        </div>
                        <div class="col-4 text-right">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-c-pink update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            <h4 class="text-white">{{ studentCount() }}</h4>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-c-lite-green update-card">
                <div class="card-block">
                    <div class="row align-items-end">
                        <div class="col-8">
                            <h4 class="text-white">{{ teacherCount() }}</h4>
                            <h6 class="text-white m-b-0">Total Teacher</h6>
                        </div>
                        <div class="col-4 text-right">
        ...
        {{--                                            class="__cf_email__"--}}
        {{--                                            data-cfemail="ed87888394ad8a808c8481c38e8280">[email&#160;protected]</a>--}}
        {{--                                    </h6>--}}
        {{--                                </div>--}}
        {{--                                <div class="col-sm-6">--}}
