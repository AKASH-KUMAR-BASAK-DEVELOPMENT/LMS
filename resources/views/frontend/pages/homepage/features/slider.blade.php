...
<div id="mainBannerCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-inner">
        @foreach ($sliders as $key => $slider)
            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                <section class="pt-0 position-relative overflow-hidden h-700px h-sm-600px h-lg-700px rounded-top-4 mx-2 mx-md-4" style="background-image:url({{ asset($slider->image) }}); background-position: center; background-size: cover;">
                            ...
                            <div class="col-sm-10 col-lg-8 col-xl-6 all-text-white my-5 mt-md-0">
                                <div class="py-0 py-md-5 my-5">
                                    ...
                                    <div class="d-inline-block bg-white px-3 py-2 rounded-pill mb-3">
                                        <p class="mb-0 text-dark"><span class="badge text-bg-success rounded-pill me-1">New Feature</span>	Real time live video online exam system </p>
                                    </div>

                                    <!-- Title -->
                                    <h1 class="text-white display-5">{{ $slider->title }}</h1>
                                    <p class="text-white">{{ $slider->description }}</p>

                                    <div class="d-sm-flex align-items-center mt-4">
                                        <!-- Button -->
                                        <a href="{{ $slider->link }}" class="btn btn-primary me-2 mb-4 mb-sm-0">More Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Controls -->
    <a class="carousel-control-prev" href="#mainBannerCarousel" role="button" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </a>
    <a class="carousel-control-next" href="#mainBannerCarousel" role="button" data-bs-slide="next">
