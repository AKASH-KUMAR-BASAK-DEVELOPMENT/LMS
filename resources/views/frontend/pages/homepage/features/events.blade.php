                ...
                <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-dots="false" data-items-xl="3" data-items-md="2" data-items-xs="1">
                    ...
                    <div class="card bg-transparent">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="{{ asset('frontend-1/assets/images/courses/4by3/21.jpg') }}" class="card-img" alt="course image">
                            <!-- Overlay -->
                    ...
                    <div class="card bg-transparent">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="{{ asset('frontend-1/assets/images/courses/4by3/16.jpg') }}" class="card-img" alt="course image">
                            <!-- Overlay -->
                            <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                <div class="w-100 mt-auto">
                                    <!-- Category -->
                    ...
                    <div class="card bg-transparent">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="{{ asset('frontend-1/assets/images/courses/4by3/18.jpg') }}" class="card-img" alt="course image">
                            <!-- Overlay -->
                            <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                <div class="w-100 mt-auto">
                                    <!-- Category -->
                    ...
                    <div class="card bg-transparent">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="{{ asset('frontend-1/assets/images/courses/4by3/17.jpg') }}" class="card-img" alt="course image">
                            <!-- Overlay -->
                            <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                <div class="w-100 mt-auto">
                                    <!-- Category -->
                    ...
                    <div class="card bg-transparent">
                        <div class="position-relative">
                            <!-- Image -->
                            <img src="{{ asset('frontend-1/assets/images/courses/4by3/19.jpg') }}" class="card-img" alt="course image">
                            <!-- Overlay -->
                            <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                <div class="w-100 mt-auto">
                                    <!-- Category -->
